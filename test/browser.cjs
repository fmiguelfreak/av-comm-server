...
(async () => {
  ...
  try {
    ...
    await contextA.addInitScript(require('./speech-mock.cjs'));
    await contextB.addInitScript(require('./speech-mock.cjs'));
    ...
    await a.waitForFunction(() => document.getElementById('ptt-overlay').classList.contains('hidden'));
    ...
    await require('./voice-browser.cjs')(browser, base, io);
